...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.extracted_content'
        db.add_column('core_document', 'extracted_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DerivedFile.extracted_content'
        db.add_column('core_derivedfile', 'extracted_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.extracted_content'
        db.delete_column('core_document', 'extracted_content')

        # Deleting field 'DerivedFile.extracted_content'
        db.delete_column('core_derivedfile', 'extracted_content')
